          ...
          return (
            <div className="speakshine-hero-grid">
              ...
              <div className="speakshine-hero-left-card" onWheel={handleHeroWheel} style={{
                ...
                {/* Target Vocabulary Section Card (Directly Below Question Prompt & Tip) */}
                {normalizedVocab && normalizedVocab.length > 0 && (
                  <div
                    className="speakshine-vocab-card-box"
                    style={{
                      background: isDark ? "rgba(255, 255, 255, 0.025)" : "#ffffff",
                      border: isDark ? "1px solid rgba(255, 255, 255, 0.08)" : "1px solid #e2e8f0",
                      borderRadius: 16,
                      padding: vocabDropdownOpen ? "1.2rem 1.25rem 1.3rem" : "0.9rem 1.15rem",
                      display: "flex",
                      flexDirection: "column",
                      gap: vocabDropdownOpen ? "0.85rem" : "0.55rem",
                      boxShadow: isDark ? "0 8px 24px rgba(0, 0, 0, 0.25)" : "0 4px 16px rgba(0, 0, 0, 0.04)",
