      ...
      <div className="video-analysis-page">
        ...
        {(todayQuestion || isMonthlyGoals || isMonthlyReflection) && (() => {
          ...
          const renderVocabChallenge = (isOpen, setIsOpen, isLeftColumn = false) => {
            if (!normalizedVocab || normalizedVocab.length === 0) return null;
            return (
              <div
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexShrink: 0 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: isOpen ? "1px solid rgba(168, 85, 247, 0.4)" : "1px solid rgba(255, 255, 255, 0.1)",
                        color: isOpen ? "#c084fc" : "#e2e8f0",
                        borderRadius: 8,
                        padding: "4px 9px",
                        fontSize: "0.74rem",
                        fontWeight: 700,
          ...
          return (
            <div className="speakshine-hero-grid">
              ...
              <div className="speakshine-hero-left-card" onWheel={handleHeroWheel} style={{
                ...
                {/* Target Vocabulary Section Card (Directly Below Question Prompt & Tip - Default Hidden) */}
                ...
                <div>
                  ...
                  {normalizedVocab && normalizedVocab.length > 0 && (
                    <div style={{
                      ...
                      {(() => {
                        const currentCefr = getCefrInfo(vocabLevel || "B2");
                        return (
                          <>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.35rem" }}>
                              ...
                              <span style={{
                                ...
                                padding: "2px 8px",
                                borderRadius: 999,
                                background: currentCefr?.bg || (isDark ? "rgba(192, 132, 252, 0.16)" : "rgba(124, 58, 237, 0.1)"),
                                border: `1px solid ${currentCefr?.border || (isDark ? "rgba(192, 132, 252, 0.4)" : "rgba(124, 58, 237, 0.3)")}`,
                                color: currentCefr?.color || (isDark ? "#c084fc" : "#7c3aed"),
                                display: "inline-flex",
                                alignItems: "center",
                                gap: "4px",
                                textTransform: "uppercase",
                              }}>
                                <span style={{ width: 5, height: 5, borderRadius: "50%", background: currentCefr?.color || "#c084fc" }} />
                                {currentCefr?.label || `${vocabLevel || "B2"} Level`}
                              </span>
                            </div>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.55rem" }}>
                              <span style={{
                                ...
                                <span>🎯</span>
                                <span>Use at least <strong>{Math.min(vocabRequiredCount || 1, normalizedVocab.length)} of {normalizedVocab.length}</strong> words</span>
                              </span>
                              <span style={{
                                fontSize: "0.65rem",
                                fontWeight: 800,
                      ...
                      <div style={{
                        ...
                        {normalizedVocab.slice(0, 5).map((v, i) => {
                          const isPlanned = !!plannedWords[i];
                          const isSpeaking = speakingVocabIndex === i;
                          return (
                            <button
